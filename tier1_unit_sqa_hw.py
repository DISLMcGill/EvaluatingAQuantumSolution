...
-----
    ...
    python tier1_unit_sqa_hw.py                       # subset (36 cases), interactive
    python tier1_unit_sqa_hw.py --no-pause            # subset (36 cases), unattended
    python tier1_unit_sqa_hw.py --full --no-pause     # full tier-1 (180 cases), unattended
"""
...
def main() -> int:
    ...
    output_path = run_experiment(
        ...
        resume=args.resume,
        note=(
            f"tier1_unit_sqa_hw.py [{mode_label}] -- "
